    ...
    def save_HSV_config_csv(parent, sliders, images_dict, lines):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            with open(fileName, 'w', newline='') as f:
                ...
                writer.writerow([YOLO_CONFIDENCE_THRESHOLD, parent.getYoloConfidenceThreshold()])
                writer.writerow([NMS_THRESHOLD, parent.getNMSThreshold()])
    ...
    def read_HSV_config_csv(parent, sliders, images_dict, label_dict):
        ...
        try:
            with open(fileName, 'r', newline='') as f:
                ...
                parent.setNMSThreshold(config_dict.get(NMS_THRESHOLD, parent.getNMSThreshold()))

                parent.getConfSliders().update()
