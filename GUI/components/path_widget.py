...
from GUI.strings.path_widget import CFG_PATH_PLACEHOLDER_STRING, IMAGE_PATH_STRING, LOAD_CFG_BUTTON_STRING, LOAD_CFG_BUTTON_TOOLTIP_STRING, WEIGHT_PATH_STRING, CFG_PATH_STRING, IMAGE_PATH_PLACEHOLDER_STRING, VIDEO_PATH_PLACEHOLDER_STRING, WEIGHT_PATH_PLACEHOLDER_STRING, VIDEO_PATH_PLACEHOLDER_STRING, VIDEO_PATH_STRING, LOAD_VIDEO_BUTTON_STRING, LOAD_VIDEO_BUTTON_TOOLTIP_STRING, LOAD_WEIGHT_BUTTON_STRING, LOAD_WEIGHT_BUTTON_TOOLTIP_STRING
...
class PathWidget:
    ...
    def loadWeight(self):
        filename = GUIUtils.selectFileDialog(self.parent, "Select a YOLOv4 weight", "Weight Files(*.weight)")
    ...
    def setup(self ):
        ...
        self.image_path_label = QLabel(self.parent.getSourceImagePath() or IMAGE_PATH_PLACEHOLDER_STRING)
        ...
        self.video_path_label = QLabel(self.parent.getVideoPath() or VIDEO_PATH_PLACEHOLDER_STRING)
        ...
        self.weight_path_label = QLabel(self.parent.getWeightPath() or WEIGHT_PATH_PLACEHOLDER_STRING)
        ...
        self.path_layout.addWidget(self.button_load_weight, 6, 1)

        self.path_layout.addWidget(QLabel(CFG_PATH_STRING), 6, 0)
        self.cfg_path_label = QLabel(self.parent.getWeightPath() or CFG_PATH_PLACEHOLDER_STRING)
